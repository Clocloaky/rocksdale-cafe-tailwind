...
const About = () => {
    return (
        <about>
            <div className='pt-[100px] grid grid-cols-1 lg:grid-cols-3 '>
                ...
                <div className='grid grid-cols-2 z-10 px-10'>
                    <div>
                    <button className='' >
                    ...
                    <form className='col-span-2'>
                        <label className="block text-gray-700 text-sm font-bold p-2" for="fname">First name</label>
                        ...
                        <label className="block text-gray-700 text-sm font-bold p-2" for="lname">Last name</label>
                        ...
                        <label className="block text-gray-700 text-sm font-bold p-2" for="email">Email</label>
                        ...
                        <label className="block text-gray-700 text-sm font-bold p-2" for="password">Password</label>
                        ...
                        <label class="pt-4 md:w-2/3 block text-gray-500 font-bold">
